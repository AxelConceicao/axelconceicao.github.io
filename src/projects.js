export const projects = [
  {
    ...
    demo: 'https://polaris-web.herokuapp.com/',
    github: '',
    techno: ['Nuxt.js', 'Vue.js', 'Buefy (Bulma)'],
    images: [
      {
  ...
  {
    name: 'EL SYSTEM',
    desc: "EL SYSTEM FRANCE est une PME dans le secteur du commerce de gros. L'entreprise souhaitait un site web se rapprochant plus d'un catalogue que d'une boutique en ligne. En effet l'inscription doit être approuvé par l'entreprise et est réservé aux profressionels. Les prix sont masqués si l'utilisateur n'est pas connecté et le site est dépourvu de moyen de paiement (l'interface de paiement génère un bon de commande).",
    demo: 'https://elsystem.fr/',
    github: '',
    techno: ['Django', 'Vue.js', 'Vuetify'],
    images: [
      {
